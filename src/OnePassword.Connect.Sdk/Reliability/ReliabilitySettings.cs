namespace OnePassword.Connect.Sdk.Reliability;
...
public class ReliabilitySettings
{
    ...
    /// </summary>
    public List<HttpStatusCode> RetryableServerErrorStatusCodes { get; } = [..DefaultRetryableServerErrorStatusCodes];

    /// <summary>
    /// Gets default status codes for which request would be retied.
    /// </summary>
    public static List<HttpStatusCode> DefaultRetryableServerErrorStatusCodes { get; } =
    [
